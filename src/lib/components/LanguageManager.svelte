<script>
    ...
    export let path = '$lang';
    export let preSelected = 'EN';

    const createLanguageManager = (langPath = path, defaultLang = preSelected) => {
    ...
    const changeLang = (lang) => langManager.setLanguage(lang);
